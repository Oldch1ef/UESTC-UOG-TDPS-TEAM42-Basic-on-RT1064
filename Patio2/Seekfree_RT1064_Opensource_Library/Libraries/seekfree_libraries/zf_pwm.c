...
/*	   if((abs_minus(rightav,line1))>12||(abs_minus(rightav,line2))>12)    //line1 line2 small
	 ...
	 */		 
	 if(rightav>12+line3||rightav>12+line4) //line3,line4 small
		 {		  
			 motor1=30000;
			 motor2=-30000;
			 motor_ctr(motor1,motor2);
    ...
    if(leftav>18+line5||leftav>18+line6){
		   motor1=-30000;
			 motor2=30000;
			 motor_ctr(motor1,motor2);
			 systick_delay_ms(10);  
		 ...
		 else if(leftav>18+line7||leftav>18+line8){            //line7,line8 small
		   motor1=-20000;
			 motor2=20000;
			 motor_ctr(motor1,motor2);
			 systick_delay_ms(10);
...
//add******************************************************************************************************************
	   ...
	   //then 'beacondetected=1;'
//add****************************************************************************************************************** 
	if(line1+line2+12<line3+line4&&line5+line6>18+line7+line8){
	 if(rightav>7+line3||rightav>7+line4) //line3,line4 small
		 {		  
			 motor1=30000;
			 motor2=-30000;
			 motor_ctr(motor1,motor2);
       ...
       n=0x10000000;			 
		...
		else if(rightav>7+line1||rightav>7+line2)    //line1 line2 small
		 {
			 motor1=20000;
			 motor2=-20000;
			 motor_ctr(motor1,motor2);
       ...
       n=0x01000000;			 
		 ...
		 if(leftav>7+line5||leftav>7+line6){
		   motor1=-30000;
			 motor2=30000;
			 motor_ctr(motor1,motor2);
			 systick_delay_ms(10);  
		...
		else if(leftav>7+line7||leftav>7+line8){            //line7,line8 small
		   motor1=-20000;
			 motor2=20000;
			 motor_ctr(motor1,motor2);
			 systick_delay_ms(10);
